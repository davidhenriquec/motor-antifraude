...
**Onde foi usada:** a análise do enunciado, a exploração de alternativas de arquitetura, a redação da documentação e
parte da escrita do código foram feitas em diálogo com o Claude (Anthropic).

**Como foi usada:** como interlocutor técnico, para levantar trade-offs e questionar decisões. Cada decisão registrada
passou por questionamento e validação minha — várias propostas iniciais da ferramenta foram recusadas e estão
documentadas como alternativas descartadas.

**O que não foi delegado:** as decisões de arquitetura, o recorte de escopo, e a validação do que faz sentido para o
problema.
